...
if (mysqli_num_rows($query_res) == 1) {
    ...
    <body class='landing'>
        <!-- Header -->
        <header id='header'>
            <h1 id='logo'>ALL ABSENTEES</h1>
            <?php include ("navbar.php");
            $current_date = date("Y-m-d");
            $stud_query8 = "SELECT * FROM stud_attendance where entry_status='absent' ORDER BY entry_date desc";
            ...
            $staff_query7 = "SELECT * FROM staff_attendance where entry_status='absent' ORDER BY entry_date desc";
